...
const About = ({ t }) => {
  ...
  return (
    <div id="sobreMI" className="container-fluid">
      <div className="row align-items-center justify-content-center" style={{ marginTop: "4.5rem" }}>
      ...
      <div className="col-md-4 col-12 mt-4 text-center mb-4 mb-md-0">
        ...
        <div className="col-md-6 col-12 mt-4 text-center">
          ...
          <Drawer
  title={<div className="text-white">¡Un vistazo más de cerca! 😎</div>}
  placement="right"
...
>
          ...
          <Row>
            <Col xs={24} sm={12}>
              <Typography.Title level={4}>Compañía de seguros</Typography.Title>
              <p>
                Durante mi año en la compañía de seguros, pude sumergirme en el
                emocionante mundo de las páginas y aplicaciones web utilizando
                Vue.js y Nuxt. Y no solo eso, también tuve la oportunidad de
                coquetear con React, lo que me permitió obtener una amplia
                experiencia en el desarrollo frontend. Gracias a Axios, me
                convertí en un maestro en la conexión de servicios. 😏
              </p>
            </Col>
            <Col xs={24} sm={12}>
              <img
          ...
          <p>
            Mis habilidades abarcan desde la programación y la robótica hasta la
            fotografía y la pintura. En mis ratos libres, disfruto de una buena
            partida de videojuegos, cocinar deliciosas comidas e incluso ¡soy un
            hábil carpintero! En el ámbito técnico, mis habilidades incluyen
            electrónica, hidráulica, neumática y mecánica. ¡Soy un ingeniero
            mecatrónico y programador web multidisciplinario! 😁
          </p>
          <Divider />
          <Typography.Title level={3} className="section-title">
          ...
          <p>
            ...
            aplicaciones web hasta proyectos de robótica, siempre busco desafíos
            que me permitan aprender y crecer como profesional.
          </p>
          <Row>
          ...
          <p>
            Si crees que mis habilidades y experiencia encajan con lo que estás
            buscando, ¡no dudes en ponerte en contacto conmigo! Estoy ansioso
            por escuchar sobre tus proyectos y cómo puedo contribuir. ¡Hasta
            pronto! <SmileOutlined />
          </p>
        </Drawer>
        ...
        <div className=" col-12 mt-5 order-md-2">
          ...
          <div className="row justify-content-center col-7 col-md-3 m-3 ">
          
            <div className=" row m-3 text-center p-3 rounded" style={{ background: "rgba(0,0,255,0.2)"  }}>
            <h2 className="col-12 fs-5 mb-4 justify-content-center">{t("About.hobbies")}</h2>
            <ul className="fs-5 " >
          ...
          <div className="row justify-content-center  col-7 col-md-3 m-3 justify-content-center">
            <div className=" row text-center p-3 rounded justify-content-center" style={{ background: "rgba(255,255,255,0.2)" }}>
            <h2 className="col-12 fs-5 mb-4 justify-content-center">{t("About.strengths")}</h2>
          ...
          <div className="row justify-content-center  col-7 col-md-3 m-3  justify-content-center">
            <div className=" row  text-center p-3 rounded justify-content-center" style={{ background: "rgba(0,255,0,0.2)"  }}>
            <h2 className="col-12 fs-5 mb-4 justify-content-center">{t("About.abilities")}</h2>
            <ul className="fs-5 justify-content-center">
